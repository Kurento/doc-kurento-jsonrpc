...
help:
	...
	@echo "             KurentoJsonRpc.{pdf,epub} in $(BUILDDIR)/html and make a tgz"
	@echo "             as docs-kurento-jsonrpc-$(DOC_VERSION).tgz"
...
dist: clean langdoc html epub latexpdf
	...
	@echo
	cp $(BUILDDIR)/epub/KurentoJsonRpc.epub $(BUILDDIR)/latex/KurentoJsonRpc.pdf $(BUILDDIR)/html &&\
	tar zcvf $(BUILDDIR)/dist/docs-kurento-jsonrpc-$(DOC_VERSION).tgz -C $(BUILDDIR)/html .
