# -*- coding: utf-8 -*-
#
# Kurento JsonRpc documentation build configuration file, created by
...
latex_documents = [
  ('pdfindex', 'KurentoJsonRpc.tex', u'KurentoJsonRpc Documentation',
...
man_pages = [
    ('index', 'kurentoJsonRpc', u'KurentoJsonRpc Documentation',
     [u'kurento.org'], 1),
...
texinfo_documents = [
  ('index', 'KurentoJsonRpc', u'KurentoJsonRpc Documentation',
   u'kurento.org', 'KurentoJsonRpc', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'KurentoJsonRpc'
epub_author = u'KurentoJsonRpc'
epub_publisher = u'KurentoJsonRpc'
